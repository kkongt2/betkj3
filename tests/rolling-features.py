...
assert len(f['1']['raw'])==16 and f['1']['raw'][11] is not None
...
print('PASS outcome isolation, strict past date, corrected burden, relative finish, identity and 16 feature schema')
