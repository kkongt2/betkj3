...
const RollingPanel=(()=>{
 ...
 async function init(apply){
  ...
  }catch{root.textContent='서울 전용 검증 결과를 불러오지 못했습니다. 새로고침해 주세요.';button.hidden=true;}
 }
 return {init};
})();
