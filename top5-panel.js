...
const Top5Panel=(()=>{
 ...
 async function init(apply){
  ...
  }catch{root.textContent='상위 5개 프리셋을 불러오지 못했습니다. 새로고침해 주세요.';}
 }
 return {init};
})();
