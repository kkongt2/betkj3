...
function renderOverview(){
 ...
 $('#overviewStatus').textContent='서울 '+list.length+'경주 · 현재 가중치로 계산한 후보와 실제 결과';
}
