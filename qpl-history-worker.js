'use strict';
importScripts('model.js?v=last5-1','tuning-model.js?v=last5-1','qpl-policy.js?v=last5-1','qpl-history-engine.js?v=curves-1','weight-curve-engine.js?v=curves-1');
let ready=null,latest=0,latestCurve=0;
